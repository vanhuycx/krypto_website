...
export const TransactionProvider = ({children}) => {
    ...
    //transactionCount reset when the browser resets so we store it in the local storage
    ...
    const sendTransaction = async () => {
        try {
            ...
            //convert 'decimal' amount to GWEI amount
            const passedAmount = ethers.utils.parseEther(amount)
